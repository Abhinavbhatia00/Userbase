      ...
      <main className="mx-auto w-[calc(100%-28px)] max-w-3xl py-10 md:w-[calc(100%-48px)]">
        ...
        <section className="mt-6 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
          <div className="border-b border-gray-200 p-6 md:p-8">
            ...
            <p className="mt-2 text-gray-500">{user.company.name}</p>
          </div>
          ...
          <div className="grid gap-6 p-6 md:grid-cols-2 md:p-8">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-gray-700">{user.website}</p>
            </div>
            <div>
              <p className="mb-1 text-xs font-semibold text-gray-400 uppercase">City</p>
              <p className="text-sm font-semibold text-gray-700">{user.address.city}</p>
            </div>
          </div>
        </section>
      </main>
